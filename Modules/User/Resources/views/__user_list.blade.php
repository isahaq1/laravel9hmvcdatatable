                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                @if($user->image)
                                                    <img src="{{url('/public/'.$user->image)}}" class="rounded-circle" width="50" alt="...">
                                                @else
                                                    <img src="{{url('/public/assets/dist/img/avatar-1.jpg')}}" class="rounded-circle" width="50" alt="...">
                                                @endif
                                            </div>
                                        </td>
            ...
            $('#userList').on('click', '#editAction', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('#midelname').val(res.data.midelname);
                        $('#phone').val(res.data.phone);
                        $('#image').val(res.data.image_image);
                        ...
                        $('#lassra').val(res.data.lassra);
                        $('#nin').val(res.data.nin);
                        $('#bvn').val(res.data.bvn);

                        $('#lga').val(res.data.lga).trigger('change');
                        $('#education').val(res.data.education).trigger('change');
                        ...
                        $('#guarantor_id_type').val(res.guarantor.guarantor_id_type);
