...
Route::middleware(['auth','XssSanitization'])->group(function () {
    Route::resource('user', UserController::class);
    Route::get('user-profile', 'UserController@profile')->name('user-profile');
    Route::get('device-request', 'DeviceRequestController@index')->name('device-request');
    Route::get('deviceRequestListAjax', 'DeviceRequestController@get_request_ajaxdata')->name('deviceRequestListAjax');
