                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fs-17 fw-semi-bold mb-0">Invoice</h6>
                            </div>
                            <div class="text-end">
                                ...
                                <tbody>
                                   @foreach ($invoices as $key => $invoice)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('packages-invoices.edit',$invoice->id) }}" class="text-primary"><i class="fa fa-edit"></i></a>
                                                <a href="javascript:void(0)" class="text-success" data-bs-toggle="modal" data-bs-target="#invoice-{{ $invoice->id }}"><i class="fa fa-eye"></i></a>
                                                 @include('subcription::modals.invoice-details')
                                                <a href="javascript:void(0)" class="text-danger delete-confirm" data-route="{{ route('packages-invoices.destroy',$invoice->id) }}" data-csrf="{{csrf_token()}}"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                   @endforeach
                                </tbody>
