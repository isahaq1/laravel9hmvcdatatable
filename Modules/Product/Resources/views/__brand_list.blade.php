    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @include('product::modal.__brand_modal')
                <div class="card-body">
                        ...
                        <table id="example" class="table display table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" class="btn btn-success-soft btn-sm me-1" id="editAction" data-update-route="{{ route('product-brand.update',$item->id) }}" data-edit-route="{{ route('product-brand.edit',$item->id) }}"  ><i class="far fa-edit"></i></a>
                                        <a href="javascript:void(0)" class="btn btn-danger-soft btn-sm" id="deleteAction" data-route="{{ route('product-brand.destroy',$item->id) }}"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
