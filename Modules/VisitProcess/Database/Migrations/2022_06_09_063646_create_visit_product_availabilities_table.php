...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('visit_product_availabilities', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('availability_qty')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('visit_product_availabilities');
    }
};
